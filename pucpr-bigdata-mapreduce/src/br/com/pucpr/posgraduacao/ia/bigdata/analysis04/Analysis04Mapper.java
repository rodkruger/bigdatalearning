...
/**
 * Mapper used to group the weight by commodity and year
 */
public class Analysis04Mapper extends Mapper<LongWritable, Text, CommodityPerYear, AverageOfTransactionsWritable> {
