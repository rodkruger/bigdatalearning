...
/**
 * Analysis 05 - calculates the weight average, per commodity in each year, in Brazil
 */
public class Analysis05 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Analysis05 analysis = new Analysis05(args);
    ...
    public Analysis05(String args[]) throws IOException {
        ...
        this.averagePerYear = this.outputDirectory + "/analysis05.csv";
    ...
    public boolean runAnalysis01() throws IOException, InterruptedException, ClassNotFoundException {
        ...
        // job creation
        Job job = new Job(this.configuration, "analysis05-job");

        // set the mapper and reducer classes
        job.setJarByClass(Analysis05.class);
        job.setMapperClass(Analysis05Mapper.class);
        job.setReducerClass(Analysis05Reducer.class);
